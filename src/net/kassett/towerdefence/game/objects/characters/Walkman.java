...
public class Walkman extends PathableGameObject implements IGameObject {
	...
	public Walkman(Vec2 startPosition, Point target, Team team, Level level, int currentHealth, AStarPathFinder pathfinder){		
